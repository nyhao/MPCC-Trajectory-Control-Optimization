...
%     model.objective{i} = @(z) [sin(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+1)-ppval(xpp,z(nu+nalu+nx+1))) - ...
%         cos(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+2)-ppval(ypp,z(nu+nalu+nx+1))); ...
%         -cos(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+1)-ppval(xpp,z(nu+nalu+nx+1))) - ...
%         sin(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+2)-ppval(ypp,z(nu+nalu+nx+1))); ...
%         z(nu+nalu+3) - ppval(zpp,z(nu+nalu+nx+1))]'*Qp* ...
%         [sin(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+1)-ppval(xpp,z(nu+nalu+nx+1))) - ...
%         cos(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+2)-ppval(ypp,z(nu+nalu+nx+1))); ...
%         -cos(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+1)-ppval(xpp,z(nu+nalu+nx+1))) - ...
%         sin(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+2)-ppval(ypp,z(nu+nalu+nx+1))); ...
%         z(nu+nalu+3) - ppval(zpp,z(nu+nalu+nx+1))] - Qdtheta*(z(nu+nalu+nx+2)) + ...
%         (z(nu+nalu+9:nu+nalu+nx))'*Qj*(z(nu+nalu+9:nu+nalu+nx)) + ...
%         (z(nu+nalu+nx+3:nu+nalu+nx+nalx))'*Qjtheta*(z(nu+nalu+nx+3:nu+nalu+nx+nalx));

    model.objective{i} = @(z,poly) ...
        [sin(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
        *(z(nu+nalu+1)-polyval(poly(1:3)',z(nu+nalu+nx+1))) - ...
        cos(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
        *(z(nu+nalu+2)-polyval(poly(4:6)',z(nu+nalu+nx+1))); ...
        -cos(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
        *(z(nu+nalu+1)-polyval(poly(1:3)',z(nu+nalu+nx+1))) - ...
        sin(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
        *(z(nu+nalu+2)-polyval(poly(4:6)',z(nu+nalu+nx+1))); ...
        z(nu+nalu+3) - polyval(poly(7:9)',z(nu+nalu+nx+1))]'*Qp* ...
        [sin(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
        *(z(nu+nalu+1)-polyval(poly(1:3)',z(nu+nalu+nx+1))) - ...
        cos(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
        *(z(nu+nalu+2)-polyval(poly(4:6)',z(nu+nalu+nx+1))); ...
        ...
        *(z(nu+nalu+1)-polyval(poly(1:3)',z(nu+nalu+nx+1))) - ...
        sin(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
        *(z(nu+nalu+2)-polyval(poly(4:6)',z(nu+nalu+nx+1))); ...
        z(nu+nalu+3) - polyval(poly(7:9)',z(nu+nalu+nx+1))] - Qdtheta*(z(nu+nalu+nx+2)) + ...
        (z(nu+nalu+9:nu+nalu+nx))'*Qj*(z(nu+nalu+9:nu+nalu+nx)) + ...
        (z(nu+nalu+nx+3:nu+nalu+nx+nalx))'*Qjtheta*(z(nu+nalu+nx+3:nu+nalu+nx+nalx));
end
...
% model.objective{model.N} = @(z) [sin(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+1)-ppval(xpp,z(nu+nalu+nx+1))) - ...
%     cos(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+2)-ppval(ypp,z(nu+nalu+nx+1))); ...
%     -cos(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+1)-ppval(xpp,z(nu+nalu+nx+1))) - ...
%     sin(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+2)-ppval(ypp,z(nu+nalu+nx+1))); ...
%     z(nu+nalu+3) - ppval(zpp,z(nu+nalu+nx+1))]'*Pp* ...
%     [sin(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+1)-ppval(xpp,z(nu+nalu+nx+1))) - ...
%     cos(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+2)-ppval(ypp,z(nu+nalu+nx+1))); ...
%     -cos(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+1)-ppval(xpp,z(nu+nalu+nx+1))) - ...
%     sin(phi(z(nu+nalu+nx+1)))*(z(nu+nalu+2)-ppval(ypp,z(nu+nalu+nx+1))); ...
%     z(nu+nalu+3) - ppval(zpp,z(nu+nalu+nx+1))] - Pdtheta*(z(nu+nalu+nx+2)) + ...
%     (z(nu+nalu+9:nu+nalu+nx))'*Pj*(z(nu+nalu+9:nu+nalu+nx)) + ...
%     (z(nu+nalu+nx+3:nu+nalu+nx+nalx))'*Pjtheta*(z(nu+nalu+nx+3:nu+nalu+nx+nalx));

model.objective{model.N} = @(z,poly) ...
    [sin(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
    *(z(nu+nalu+1)-polyval(poly(1:3)',z(nu+nalu+nx+1))) - ...
    cos(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
    *(z(nu+nalu+2)-polyval(poly(4:6)',z(nu+nalu+nx+1))); ...
    ...
    *(z(nu+nalu+1)-polyval(poly(1:3)',z(nu+nalu+nx+1))) - ...
    sin(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
    *(z(nu+nalu+2)-polyval(poly(4:6)',z(nu+nalu+nx+1))); ...
    z(nu+nalu+3) - polyval(poly(7:9)',z(nu+nalu+nx+1))]'*Pp* ...
    [sin(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
    *(z(nu+nalu+1)-polyval(poly(1:3)',z(nu+nalu+nx+1))) - ...
    cos(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
    *(z(nu+nalu+2)-polyval(poly(4:6)',z(nu+nalu+nx+1))); ...
    ...
    *(z(nu+nalu+1)-polyval(poly(1:3)',z(nu+nalu+nx+1))) - ...
    sin(atan2(polyval(poly(12:13)',z(nu+nalu+nx+1)),polyval(poly(10:11)',z(nu+nalu+nx+1)))) ...
    *(z(nu+nalu+2)-polyval(poly(4:6)',z(nu+nalu+nx+1))); ...
    z(nu+nalu+3) - polyval(poly(7:9)',z(nu+nalu+nx+1))] - Pdtheta*(z(nu+nalu+nx+2)) + ...
    (z(nu+nalu+9:nu+nalu+nx))'*Pj*(z(nu+nalu+9:nu+nalu+nx)) + ...
    (z(nu+nalu+nx+3:nu+nalu+nx+nalx))'*Pjtheta*(z(nu+nalu+nx+3:nu+nalu+nx+nalx));
...
model.E = [[zeros(nx-4,nu+nalu); (-1/T*m)*[eye(4), zeros(4,1)]; (-1/T*m)*[zeros(3,4), [0;0;1]]], eye(nx+nalx)];
...
while (nrid(k) ~= kmax+1)
    ...
    if (nrid(k) <= fitlength/2)
        fitrange = 1:nrid(k)+fitlength/2;
    elseif (nrid(k) >= kmax-fitlength/2)
        fitrange = nrid(k)-fitlength/2:kmax+1;
    else
        fitrange = nrid(k)-fitlength/2:nrid(k)+fitlength/2;
    end
