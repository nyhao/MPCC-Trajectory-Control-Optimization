...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Output Port 0 */
    ssSetOutputPortMatrixDimensions(S,  0, 165, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	/* Copy outputs */
	for( i=0; i<15; i++){ outputs[i] = (real_T) output.x01[i]; }
	k=15; for( i=0; i<15; i++){ outputs[k++] = (real_T) output.x02[i]; }
	k=30; for( i=0; i<15; i++){ outputs[k++] = (real_T) output.x03[i]; }
	k=45; for( i=0; i<15; i++){ outputs[k++] = (real_T) output.x04[i]; }
	k=60; for( i=0; i<15; i++){ outputs[k++] = (real_T) output.x05[i]; }
	k=75; for( i=0; i<15; i++){ outputs[k++] = (real_T) output.x06[i]; }
	k=90; for( i=0; i<15; i++){ outputs[k++] = (real_T) output.x07[i]; }
	k=105; for( i=0; i<15; i++){ outputs[k++] = (real_T) output.x08[i]; }
	k=120; for( i=0; i<15; i++){ outputs[k++] = (real_T) output.x09[i]; }
	k=135; for( i=0; i<15; i++){ outputs[k++] = (real_T) output.x10[i]; }
	k=150; for( i=0; i<15; i++){ outputs[k++] = (real_T) output.x11[i]; }
