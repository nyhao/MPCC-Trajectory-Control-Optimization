...
a Python wrapper for a fast solver generated by FORCES Pro
   ...
   subject to the parameters supplied in the following dictionary:
       ...
       PARAMS['xinit'] - column vector of length 25

   OUTPUT returns the values of the last iteration of the solver where
       OUTPUT['x01'] - column vector of size 30
       OUTPUT['x02'] - column vector of size 30
       OUTPUT['x03'] - column vector of size 30
       OUTPUT['x04'] - column vector of size 30
       OUTPUT['x05'] - column vector of size 30
       OUTPUT['x06'] - column vector of size 30
       OUTPUT['x07'] - column vector of size 30
       OUTPUT['x08'] - column vector of size 30
       OUTPUT['x09'] - column vector of size 30
       OUTPUT['x10'] - column vector of size 30
       OUTPUT['x11'] - column vector of size 30
...
#	def from_param(self):
#		return self
	_fields_ = [('x0', ctypes.c_double * 330),
('xinit', ctypes.c_double * 25),
]
...
#	def from_param(self):
#		return self
	_fields_ = [('x01', ctypes.c_double * 30),
('x02', ctypes.c_double * 30),
('x03', ctypes.c_double * 30),
('x04', ctypes.c_double * 30),
('x05', ctypes.c_double * 30),
('x06', ctypes.c_double * 30),
('x07', ctypes.c_double * 30),
('x08', ctypes.c_double * 30),
('x09', ctypes.c_double * 30),
('x10', ctypes.c_double * 30),
('x11', ctypes.c_double * 30),
]
