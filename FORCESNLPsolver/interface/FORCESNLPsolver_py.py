...
a Python wrapper for a fast solver generated by FORCES Pro
   ...
   subject to the parameters supplied in the following dictionary:
       PARAMS['x0'] - column vector of length 504
       PARAMS['xinit'] - column vector of length 20
       PARAMS['all_parameters'] - column vector of length 420
...
#	def from_param(self):
#		return self
	_fields_ = [('x0', ctypes.c_double * 504),
('xinit', ctypes.c_double * 20),
('all_parameters', ctypes.c_double * 420),
]
