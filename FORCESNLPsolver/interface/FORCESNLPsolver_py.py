...
a Python wrapper for a fast solver generated by FORCES Pro
   ...
   subject to the parameters supplied in the following dictionary:
       PARAMS['x0'] - column vector of length 492
       PARAMS['xinit'] - column vector of length 8
       PARAMS['all_parameters'] - column vector of length 328
   ...
   OUTPUT returns the values of the last iteration of the solver where
       ...
       OUTPUT['x41'] - column vector of size 12
...
#	def from_param(self):
#		return self
	_fields_ = [('x0', ctypes.c_double * 492),
('xinit', ctypes.c_double * 8),
('all_parameters', ctypes.c_double * 328),
]
