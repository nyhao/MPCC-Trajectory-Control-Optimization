...
while (nrid(k) ~= kmax+1)
    ...
    inputmsg.Linear.X = (90 - rad2deg(atan2(U(3,k),U(1,k))))/30;
    inputmsg.Linear.Y = (90 - rad2deg(atan2(U(3,k),U(2,k))))/30;
    inputmsg.Linear.Z = X(7,k+1);
    inputmsg.Angular.Z = X(8,k+1);
