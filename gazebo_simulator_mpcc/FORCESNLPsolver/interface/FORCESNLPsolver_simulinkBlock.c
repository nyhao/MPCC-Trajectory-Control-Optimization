...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	/* Copy outputs */
	for( i=0; i<28; i++){ x01[i] = (real_T) output.x01[i]; }
	for( i=0; i<28; i++){ x02[i] = (real_T) output.x02[i]; }
	for( i=0; i<28; i++){ x03[i] = (real_T) output.x03[i]; }
	for( i=0; i<28; i++){ x04[i] = (real_T) output.x04[i]; }
	for( i=0; i<28; i++){ x05[i] = (real_T) output.x05[i]; }
	for( i=0; i<28; i++){ x06[i] = (real_T) output.x06[i]; }
	for( i=0; i<28; i++){ x07[i] = (real_T) output.x07[i]; }
	for( i=0; i<28; i++){ x08[i] = (real_T) output.x08[i]; }
	for( i=0; i<28; i++){ x09[i] = (real_T) output.x09[i]; }
	for( i=0; i<28; i++){ x10[i] = (real_T) output.x10[i]; }
	for( i=0; i<28; i++){ x11[i] = (real_T) output.x11[i]; }
