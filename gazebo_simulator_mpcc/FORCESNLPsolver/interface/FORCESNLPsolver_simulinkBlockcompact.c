...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 0 */
    ssSetInputPortMatrixDimensions(S,  0, 308, 1);
	...
	/* Output Port 0 */
    ssSetOutputPortMatrixDimensions(S,  0, 308, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	/* Copy inputs */
	for( i=0; i<308; i++){ params.x0[i] = (double) x0[i]; }
	for( i=0; i<21; i++){ params.xinit[i] = (double) xinit[i]; }
	...
	/* Copy outputs */
	for( i=0; i<28; i++){ outputs[i] = (real_T) output.x01[i]; }
	k=28; for( i=0; i<28; i++){ outputs[k++] = (real_T) output.x02[i]; }
	k=56; for( i=0; i<28; i++){ outputs[k++] = (real_T) output.x03[i]; }
	k=84; for( i=0; i<28; i++){ outputs[k++] = (real_T) output.x04[i]; }
	k=112; for( i=0; i<28; i++){ outputs[k++] = (real_T) output.x05[i]; }
	k=140; for( i=0; i<28; i++){ outputs[k++] = (real_T) output.x06[i]; }
	k=168; for( i=0; i<28; i++){ outputs[k++] = (real_T) output.x07[i]; }
	k=196; for( i=0; i<28; i++){ outputs[k++] = (real_T) output.x08[i]; }
	k=224; for( i=0; i<28; i++){ outputs[k++] = (real_T) output.x09[i]; }
	k=252; for( i=0; i<28; i++){ outputs[k++] = (real_T) output.x10[i]; }
	k=280; for( i=0; i<28; i++){ outputs[k++] = (real_T) output.x11[i]; }
