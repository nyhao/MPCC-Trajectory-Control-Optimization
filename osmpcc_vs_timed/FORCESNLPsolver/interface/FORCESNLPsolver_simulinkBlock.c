...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	/* Copy outputs */
	for( i=0; i<33; i++){ x001[i] = (real_T) output.x001[i]; }
	for( i=0; i<33; i++){ x002[i] = (real_T) output.x002[i]; }
	for( i=0; i<33; i++){ x003[i] = (real_T) output.x003[i]; }
	for( i=0; i<33; i++){ x004[i] = (real_T) output.x004[i]; }
	for( i=0; i<33; i++){ x005[i] = (real_T) output.x005[i]; }
	for( i=0; i<33; i++){ x006[i] = (real_T) output.x006[i]; }
	for( i=0; i<33; i++){ x007[i] = (real_T) output.x007[i]; }
	for( i=0; i<33; i++){ x008[i] = (real_T) output.x008[i]; }
	for( i=0; i<33; i++){ x009[i] = (real_T) output.x009[i]; }
	for( i=0; i<33; i++){ x010[i] = (real_T) output.x010[i]; }
	for( i=0; i<33; i++){ x011[i] = (real_T) output.x011[i]; }
	for( i=0; i<33; i++){ x012[i] = (real_T) output.x012[i]; }
	for( i=0; i<33; i++){ x013[i] = (real_T) output.x013[i]; }
	for( i=0; i<33; i++){ x014[i] = (real_T) output.x014[i]; }
	for( i=0; i<33; i++){ x015[i] = (real_T) output.x015[i]; }
	for( i=0; i<33; i++){ x016[i] = (real_T) output.x016[i]; }
	for( i=0; i<33; i++){ x017[i] = (real_T) output.x017[i]; }
	for( i=0; i<33; i++){ x018[i] = (real_T) output.x018[i]; }
	for( i=0; i<33; i++){ x019[i] = (real_T) output.x019[i]; }
	for( i=0; i<33; i++){ x020[i] = (real_T) output.x020[i]; }
	for( i=0; i<33; i++){ x021[i] = (real_T) output.x021[i]; }
	for( i=0; i<33; i++){ x022[i] = (real_T) output.x022[i]; }
	for( i=0; i<33; i++){ x023[i] = (real_T) output.x023[i]; }
	for( i=0; i<33; i++){ x024[i] = (real_T) output.x024[i]; }
	for( i=0; i<33; i++){ x025[i] = (real_T) output.x025[i]; }
	for( i=0; i<33; i++){ x026[i] = (real_T) output.x026[i]; }
	for( i=0; i<33; i++){ x027[i] = (real_T) output.x027[i]; }
	for( i=0; i<33; i++){ x028[i] = (real_T) output.x028[i]; }
	for( i=0; i<33; i++){ x029[i] = (real_T) output.x029[i]; }
	for( i=0; i<33; i++){ x030[i] = (real_T) output.x030[i]; }
	for( i=0; i<33; i++){ x031[i] = (real_T) output.x031[i]; }
	for( i=0; i<33; i++){ x032[i] = (real_T) output.x032[i]; }
	for( i=0; i<33; i++){ x033[i] = (real_T) output.x033[i]; }
	for( i=0; i<33; i++){ x034[i] = (real_T) output.x034[i]; }
	for( i=0; i<33; i++){ x035[i] = (real_T) output.x035[i]; }
	for( i=0; i<33; i++){ x036[i] = (real_T) output.x036[i]; }
	for( i=0; i<33; i++){ x037[i] = (real_T) output.x037[i]; }
	for( i=0; i<33; i++){ x038[i] = (real_T) output.x038[i]; }
	for( i=0; i<33; i++){ x039[i] = (real_T) output.x039[i]; }
	for( i=0; i<33; i++){ x040[i] = (real_T) output.x040[i]; }
	for( i=0; i<33; i++){ x041[i] = (real_T) output.x041[i]; }
	for( i=0; i<33; i++){ x042[i] = (real_T) output.x042[i]; }
	for( i=0; i<33; i++){ x043[i] = (real_T) output.x043[i]; }
	for( i=0; i<33; i++){ x044[i] = (real_T) output.x044[i]; }
	for( i=0; i<33; i++){ x045[i] = (real_T) output.x045[i]; }
	for( i=0; i<33; i++){ x046[i] = (real_T) output.x046[i]; }
	for( i=0; i<33; i++){ x047[i] = (real_T) output.x047[i]; }
	for( i=0; i<33; i++){ x048[i] = (real_T) output.x048[i]; }
	for( i=0; i<33; i++){ x049[i] = (real_T) output.x049[i]; }
	for( i=0; i<33; i++){ x050[i] = (real_T) output.x050[i]; }
	for( i=0; i<33; i++){ x051[i] = (real_T) output.x051[i]; }
	for( i=0; i<33; i++){ x052[i] = (real_T) output.x052[i]; }
	for( i=0; i<33; i++){ x053[i] = (real_T) output.x053[i]; }
	for( i=0; i<33; i++){ x054[i] = (real_T) output.x054[i]; }
	for( i=0; i<33; i++){ x055[i] = (real_T) output.x055[i]; }
	for( i=0; i<33; i++){ x056[i] = (real_T) output.x056[i]; }
	for( i=0; i<33; i++){ x057[i] = (real_T) output.x057[i]; }
	for( i=0; i<33; i++){ x058[i] = (real_T) output.x058[i]; }
	for( i=0; i<33; i++){ x059[i] = (real_T) output.x059[i]; }
	for( i=0; i<33; i++){ x060[i] = (real_T) output.x060[i]; }
	for( i=0; i<33; i++){ x061[i] = (real_T) output.x061[i]; }
	for( i=0; i<33; i++){ x062[i] = (real_T) output.x062[i]; }
	for( i=0; i<33; i++){ x063[i] = (real_T) output.x063[i]; }
	for( i=0; i<33; i++){ x064[i] = (real_T) output.x064[i]; }
	for( i=0; i<33; i++){ x065[i] = (real_T) output.x065[i]; }
	for( i=0; i<33; i++){ x066[i] = (real_T) output.x066[i]; }
	for( i=0; i<33; i++){ x067[i] = (real_T) output.x067[i]; }
	for( i=0; i<33; i++){ x068[i] = (real_T) output.x068[i]; }
	for( i=0; i<33; i++){ x069[i] = (real_T) output.x069[i]; }
	for( i=0; i<33; i++){ x070[i] = (real_T) output.x070[i]; }
	for( i=0; i<33; i++){ x071[i] = (real_T) output.x071[i]; }
	for( i=0; i<33; i++){ x072[i] = (real_T) output.x072[i]; }
	for( i=0; i<33; i++){ x073[i] = (real_T) output.x073[i]; }
	for( i=0; i<33; i++){ x074[i] = (real_T) output.x074[i]; }
	for( i=0; i<33; i++){ x075[i] = (real_T) output.x075[i]; }
	for( i=0; i<33; i++){ x076[i] = (real_T) output.x076[i]; }
	for( i=0; i<33; i++){ x077[i] = (real_T) output.x077[i]; }
	for( i=0; i<33; i++){ x078[i] = (real_T) output.x078[i]; }
	for( i=0; i<33; i++){ x079[i] = (real_T) output.x079[i]; }
	for( i=0; i<33; i++){ x080[i] = (real_T) output.x080[i]; }
	for( i=0; i<33; i++){ x081[i] = (real_T) output.x081[i]; }
	for( i=0; i<33; i++){ x082[i] = (real_T) output.x082[i]; }
	for( i=0; i<33; i++){ x083[i] = (real_T) output.x083[i]; }
	for( i=0; i<33; i++){ x084[i] = (real_T) output.x084[i]; }
	for( i=0; i<33; i++){ x085[i] = (real_T) output.x085[i]; }
	for( i=0; i<33; i++){ x086[i] = (real_T) output.x086[i]; }
	for( i=0; i<33; i++){ x087[i] = (real_T) output.x087[i]; }
	for( i=0; i<33; i++){ x088[i] = (real_T) output.x088[i]; }
	for( i=0; i<33; i++){ x089[i] = (real_T) output.x089[i]; }
	for( i=0; i<33; i++){ x090[i] = (real_T) output.x090[i]; }
	for( i=0; i<33; i++){ x091[i] = (real_T) output.x091[i]; }
	for( i=0; i<33; i++){ x092[i] = (real_T) output.x092[i]; }
	for( i=0; i<33; i++){ x093[i] = (real_T) output.x093[i]; }
	for( i=0; i<33; i++){ x094[i] = (real_T) output.x094[i]; }
	for( i=0; i<33; i++){ x095[i] = (real_T) output.x095[i]; }
	for( i=0; i<33; i++){ x096[i] = (real_T) output.x096[i]; }
	for( i=0; i<33; i++){ x097[i] = (real_T) output.x097[i]; }
	for( i=0; i<33; i++){ x098[i] = (real_T) output.x098[i]; }
	for( i=0; i<33; i++){ x099[i] = (real_T) output.x099[i]; }
	for( i=0; i<33; i++){ x100[i] = (real_T) output.x100[i]; }
	for( i=0; i<33; i++){ x101[i] = (real_T) output.x101[i]; }
	for( i=0; i<33; i++){ x102[i] = (real_T) output.x102[i]; }
	for( i=0; i<33; i++){ x103[i] = (real_T) output.x103[i]; }
	for( i=0; i<33; i++){ x104[i] = (real_T) output.x104[i]; }
	for( i=0; i<33; i++){ x105[i] = (real_T) output.x105[i]; }
	for( i=0; i<33; i++){ x106[i] = (real_T) output.x106[i]; }
	for( i=0; i<33; i++){ x107[i] = (real_T) output.x107[i]; }
	for( i=0; i<33; i++){ x108[i] = (real_T) output.x108[i]; }
	for( i=0; i<33; i++){ x109[i] = (real_T) output.x109[i]; }
	for( i=0; i<33; i++){ x110[i] = (real_T) output.x110[i]; }
	for( i=0; i<33; i++){ x111[i] = (real_T) output.x111[i]; }
	for( i=0; i<33; i++){ x112[i] = (real_T) output.x112[i]; }
	for( i=0; i<33; i++){ x113[i] = (real_T) output.x113[i]; }
	for( i=0; i<33; i++){ x114[i] = (real_T) output.x114[i]; }
	for( i=0; i<33; i++){ x115[i] = (real_T) output.x115[i]; }
	for( i=0; i<33; i++){ x116[i] = (real_T) output.x116[i]; }
	for( i=0; i<33; i++){ x117[i] = (real_T) output.x117[i]; }
	for( i=0; i<33; i++){ x118[i] = (real_T) output.x118[i]; }
	for( i=0; i<33; i++){ x119[i] = (real_T) output.x119[i]; }
	for( i=0; i<33; i++){ x120[i] = (real_T) output.x120[i]; }
	for( i=0; i<33; i++){ x121[i] = (real_T) output.x121[i]; }
	for( i=0; i<33; i++){ x122[i] = (real_T) output.x122[i]; }
	for( i=0; i<33; i++){ x123[i] = (real_T) output.x123[i]; }
	for( i=0; i<33; i++){ x124[i] = (real_T) output.x124[i]; }
	for( i=0; i<33; i++){ x125[i] = (real_T) output.x125[i]; }
	for( i=0; i<33; i++){ x126[i] = (real_T) output.x126[i]; }
	for( i=0; i<33; i++){ x127[i] = (real_T) output.x127[i]; }
	for( i=0; i<33; i++){ x128[i] = (real_T) output.x128[i]; }
	for( i=0; i<33; i++){ x129[i] = (real_T) output.x129[i]; }
	for( i=0; i<33; i++){ x130[i] = (real_T) output.x130[i]; }
	for( i=0; i<33; i++){ x131[i] = (real_T) output.x131[i]; }
	for( i=0; i<33; i++){ x132[i] = (real_T) output.x132[i]; }
	for( i=0; i<33; i++){ x133[i] = (real_T) output.x133[i]; }
	for( i=0; i<33; i++){ x134[i] = (real_T) output.x134[i]; }
	for( i=0; i<33; i++){ x135[i] = (real_T) output.x135[i]; }
	for( i=0; i<33; i++){ x136[i] = (real_T) output.x136[i]; }
	for( i=0; i<33; i++){ x137[i] = (real_T) output.x137[i]; }
	for( i=0; i<33; i++){ x138[i] = (real_T) output.x138[i]; }
	for( i=0; i<33; i++){ x139[i] = (real_T) output.x139[i]; }
	for( i=0; i<33; i++){ x140[i] = (real_T) output.x140[i]; }
	for( i=0; i<33; i++){ x141[i] = (real_T) output.x141[i]; }
	for( i=0; i<33; i++){ x142[i] = (real_T) output.x142[i]; }
	for( i=0; i<33; i++){ x143[i] = (real_T) output.x143[i]; }
	for( i=0; i<33; i++){ x144[i] = (real_T) output.x144[i]; }
	for( i=0; i<33; i++){ x145[i] = (real_T) output.x145[i]; }
	for( i=0; i<33; i++){ x146[i] = (real_T) output.x146[i]; }
	for( i=0; i<33; i++){ x147[i] = (real_T) output.x147[i]; }
	for( i=0; i<33; i++){ x148[i] = (real_T) output.x148[i]; }
	for( i=0; i<33; i++){ x149[i] = (real_T) output.x149[i]; }
	for( i=0; i<33; i++){ x150[i] = (real_T) output.x150[i]; }
	for( i=0; i<33; i++){ x151[i] = (real_T) output.x151[i]; }
	for( i=0; i<33; i++){ x152[i] = (real_T) output.x152[i]; }
	for( i=0; i<33; i++){ x153[i] = (real_T) output.x153[i]; }
	for( i=0; i<33; i++){ x154[i] = (real_T) output.x154[i]; }
	for( i=0; i<33; i++){ x155[i] = (real_T) output.x155[i]; }
	for( i=0; i<33; i++){ x156[i] = (real_T) output.x156[i]; }
	for( i=0; i<33; i++){ x157[i] = (real_T) output.x157[i]; }
	for( i=0; i<33; i++){ x158[i] = (real_T) output.x158[i]; }
	for( i=0; i<33; i++){ x159[i] = (real_T) output.x159[i]; }
	for( i=0; i<33; i++){ x160[i] = (real_T) output.x160[i]; }
	for( i=0; i<33; i++){ x161[i] = (real_T) output.x161[i]; }
